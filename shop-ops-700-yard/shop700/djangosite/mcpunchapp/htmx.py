...
class HTMXMCpunchListView(generic.ListView):
...
class HTMXMCpunchCreateView(generic.CreateView):
    model = models.MCpunch
    form_class = forms.MCpunchForm
...
class HTMXMCpunchDeleteView(generic.DeleteView):
    model = models.MCpunch
    success_url = reverse_lazy("mcpunchapp_MCpunch_htmx_list")

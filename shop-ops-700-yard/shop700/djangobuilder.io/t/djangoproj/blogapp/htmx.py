...
class HTMXMpostListView(generic.ListView):
    model = models.Mpost
...
class HTMXMpostCreateView(generic.CreateView):
    model = models.Mpost
    form_class = forms.MpostForm
...
class HTMXMpostDeleteView(generic.DeleteView):
    model = models.Mpost
    success_url = reverse_lazy("blogapp_Mpost_htmx_list")

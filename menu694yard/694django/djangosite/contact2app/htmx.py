...
class HTMXpeople2ListView(generic.ListView):
...
class HTMXpeople2CreateView(generic.CreateView):
    model = models.people2
    form_class = forms.people2Form
...
class HTMXpeople2DeleteView(generic.DeleteView):
    model = models.people2
    success_url = reverse_lazy("contact2app_people2_htmx_list")

...
<template id="postsManager">
  ...
  <div>  
    ...
    <!-- Search bar -->
      &nbsp <input type="text" v-model="searchterm" v-on:keyup.enter="getreqdata" placeholder="Search"><button v-on:click="clearsearch">x</button>
  ...
  methods: {
    ...
    async execute (method, resource, data) {
      ...
      .then(req => {
        ...
        console.log(req);
        // req.data includes count, results, etc.
        return req.data
      })
      .catch(e => {
        console.log("posts ~189");
        console.log(e);

<?php /* Smarty version 2.6.18, created on 2022-10-03 00:50:46
         compiled from Dataface_Edit_Record.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_Edit_Record.html', 21, false),array('block', 'fill_slot', 'Dataface_Edit_Record.html', 22, false),array('block', 'define_slot', 'Dataface_Edit_Record.html', 23, false),array('block', 'translate', 'Dataface_Edit_Record.html', 41, false),array('function', 'cancel_back_button', 'Dataface_Edit_Record.html', 24, false),array('function', 'block', 'Dataface_Edit_Record.html', 26, false),)), $this); ?>
<?php if ($this->_tpl_vars['ENV']['resultSet']->found() > 0): ?>
	<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Main_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fill_slot', array('name' => 'main_section')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
            <?php $this->_tag_stack[] = array('define_slot', array('name' => 'edit_record_back_button')); $_block_repeat=true;$this->_plugins['block']['define_slot'][0][0]->define_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>

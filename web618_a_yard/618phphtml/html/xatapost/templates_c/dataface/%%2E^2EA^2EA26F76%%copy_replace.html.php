<?php /* Smarty version 2.6.18, created on 2022-10-03 01:09:40
         compiled from copy_replace.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'copy_replace.html', 1, false),array('block', 'fill_slot', 'copy_replace.html', 2, false),array('block', 'translate', 'copy_replace.html', 7, false),array('modifier', 'escape', 'copy_replace.html', 16, false),array('function', 'html_options', 'copy_replace.html', 55, false),)), $this); ?>
...
?>
	   			<th><?php echo ((is_array($_tmp=$this->_tpl_vars['column']['widget']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</th>
...
?>
	  	<tr><td><?php echo ((is_array($_tmp=$this->_tpl_vars['record']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
	  	<?php $_from = $this->_tpl_vars['columns']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['column']):
?>
	...
	<p><img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['DATAFACE_URL'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

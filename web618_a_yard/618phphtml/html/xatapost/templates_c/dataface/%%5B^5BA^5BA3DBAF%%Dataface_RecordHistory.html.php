<?php /* Smarty version 2.6.18, created on 2022-10-03 01:40:53
         compiled from Dataface_RecordHistory.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_RecordHistory.html', 1, false),array('block', 'fill_slot', 'Dataface_RecordHistory.html', 2, false),array('block', 'translate', 'Dataface_RecordHistory.html', 38, false),array('modifier', 'escape', 'Dataface_RecordHistory.html', 4, false),array('function', 'load_record', 'Dataface_RecordHistory.html', 179, false),array('function', 'cycle', 'Dataface_RecordHistory.html', 203, false),array('function', 'actions', 'Dataface_RecordHistory.html', 206, false),)), $this); ?>
<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Record_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php $this->_tag_stack[] = array('fill_slot', array('name' => 'record_content')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	    ...
	    <script language="javascript" type="text/javascript" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['DATAFACE_URL'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/js/ajax.js"></script>

		<script language="javascript"><!--
		
			var currentTable = '<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['table'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
';
			<?php echo '
...
cell.innerHTML = "<?php $this->_tag_stack[] = array('translate', array('id' => "templates.Dataface_RecordHistory.MESSAGE_LOADING")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Loading ... Please wait ...<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>";<?php echo '
			...
			function loadHistoryRecord(id, changes, fromcurrent){
				...
				var url = \'?'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['current_record_qstr'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
...
var res = confirm(<?php $this->_tag_stack[] = array('translate', array('id' => "templates.Dataface_RecordHistory.JS_STRING_CONFIRM_RESTORE")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>'Are you sure you want to restore the current record to the history snap shot with id '+id+'?'<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>);<?php echo '
		...
		<form id="history-restore-form" action="<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['DATAFACE_SITE_HREF'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" method="POST">
...
?>
				<?php echo smarty_function_cycle(array('values' => "odd,even",'assign' => 'evenodd'), $this);?>

				<tr class='<?php echo $this->_tpl_vars['evenodd']; ?>
'>
					<td><!-- Actions -->
...
"<?php endif; ?>><?php if ($this->_tpl_vars['action']['icon']): ?><img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['action']['icon'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
"/><?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['action']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?></a></li>
						<?php endforeach; endif; unset($_from); ?>
					</ul>
...
-collapse-image" />&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['logitem']['history__id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
				...
				<tr style="display: none" class="<?php echo $this->_tpl_vars['evenodd']; ?>
" id="history-<?php echo ((is_array($_tmp=$this->_tpl_vars['logitem']['history__id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
-row">
					<td></td>
					<td></td>

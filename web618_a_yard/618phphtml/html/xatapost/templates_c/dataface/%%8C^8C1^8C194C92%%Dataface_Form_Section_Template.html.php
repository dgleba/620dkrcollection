...
">Go</a>
						...
						<?php if ($this->_tpl_vars['element']['field']['display'] != 'block'): ?>
							...
							<?php endif; ?>
						<?php endif; ?>
                        <?php if ($this->_tpl_vars['element']['field']['ajax_preview']): ?>
                            <div class="xf-ajax-preview" 
                                <?php if ($this->_tpl_vars['element']['field']['ajax_preview_event']): ?>data-xf-update-event="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['ajax_preview_event'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?>
                                data-xf-update-url="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['ajax_preview'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"
                            >

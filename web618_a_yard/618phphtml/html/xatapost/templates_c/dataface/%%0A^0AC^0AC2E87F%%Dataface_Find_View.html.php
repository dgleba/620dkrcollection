<?php /* Smarty version 2.6.18, created on 2022-10-03 00:59:51
         compiled from Dataface_Find_View.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_Find_View.html', 20, false),array('block', 'fill_slot', 'Dataface_Find_View.html', 21, false),array('block', 'translate', 'Dataface_Find_View.html', 28, false),array('block', 'define_slot', 'Dataface_Find_View.html', 30, false),array('function', 'cancel_back_button', 'Dataface_Find_View.html', 27, false),array('function', 'block', 'Dataface_Find_View.html', 29, false),array('function', 'search_form', 'Dataface_Find_View.html', 31, false),)), $this); ?>
<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Main_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php $this->_tag_stack[] = array('fill_slot', array('name' => 'main_section')); $_block_repeat=true;$this->_plugins['block']['fill_slot'][0][0]->fill_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
        <script>
            ...
            document.body.classList.add('no-table-tabs');
        </script>

...
-widget-cell" class="copy-replace-field-widget-cell" valign="top" align="left">
...
]" label="Leave Blank"><label for="-copy_replace:blank_flag[<?php echo ((is_array($_tmp=$this->_tpl_vars['fieldname'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
		...
		<button class="xf-remove-field"><span><?php $this->_tag_stack[] = array('translate', array('id' => "templates.copy_replace_quickform_element_template.LABEL_REMOVE_FIELD")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Remove Field<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span></button>
	</td>
</tr>
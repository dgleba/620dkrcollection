...
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  `number` varchar(117) DEFAULT NULL,
  `name` varchar(1102) DEFAULT NULL,
  `tech_radar_num` varchar(13) DEFAULT NULL,
  `active` varchar(38) DEFAULT NULL,
  `priority` varchar(36) DEFAULT NULL,
  `ae_lead` varchar(216) DEFAULT NULL,
  `bd_lead_si_customer` varchar(225) DEFAULT NULL,
  `ae_objective` text
...
INSERT INTO `projects` (`number`, `tech_radar_num`, `name`, `active`, `priority`, `ae_lead`, `bd_lead_si_customer`, `ae_objective`) VALUES
